...
import { Header, IconSun, Line, NavigationBar, NavigationLink, NavigationMenu, WatermelonIcon } from "../assets/styles/HeaderStyled";
      ...
      <Header>
        <nav>
          <NavigationMenu isOpen={isMenuOpen}>
            ...
            <li>
              <PrimaryButton fontSize={sizes("xs")} href="#resume">
                resume
              </PrimaryButton>
            </li>
          </NavigationMenu>
